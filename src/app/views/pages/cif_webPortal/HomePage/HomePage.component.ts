...
//     if (this.loadingStates.every(state => !state)) {
//       this.isLoading = false; // Hide loader when all images are loaded
//     }
//   }
...
//         }
//         this.loadingIndicator = false; // Hide loading indicator after data is fetched
//       },
//       error: err => {
